...
* [Doc] Specify that only headers with UTF-8 encoded values are supported in `decorate_events` extended decoration https://github.com/logstash-plugins/logstash-integration-kafka/pull/174[#174]
