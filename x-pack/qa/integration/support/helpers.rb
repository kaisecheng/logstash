...
# Certs are written to $ES_HOME/config/ as required by the ES 9.x entitlement model.
...
# SSL verification is disabled: the test CA is not in the JVM trust store.
# This client is only used for test-infrastructure calls (create/delete pipeline, start trial)
